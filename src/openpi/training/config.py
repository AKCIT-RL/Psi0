...
_CONFIGS = [
    ...
    TrainConfig(
        name="G1IndustrialScrewdriverToToteTeleop-v0",
        project_name="psi",
        num_workers=8,
        model=pi0_config.Pi0Config(
            pi05=True,
        ...
        data=LeRobotHFMDataConfig(
            repo_id=f"{os.environ['PSI_HOME']}/data/gustavo-mota/G1IndustrialScrewdriverToToteTeleop-v0",
            base_config=DataConfig(prompt_from_task=True),
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader("gs://openpi-assets/checkpoints/pi05_droid/params"),
        num_train_steps=40_000,
        ...
        pytorch_weight_path=f"{os.environ['PSI_HOME']}/cache/checkpoints/openpi/pi05_droid",
        policy_metadata={"dataset": "G1IndustrialScrewdriverToToteTeleop-v0"},
        checkpoint_base_dir=f".runs/openpi-05"
    ),
    TrainConfig(
        name="G1IndustrialSortingTeleop-psi0",
        project_name="psi",
        num_workers=8,
        model=pi0_config.Pi0Config(
            pi05=True,
        ...
        data=LeRobotHFMDataConfig(
            repo_id=f"{os.environ['PSI_HOME']}/data/gustavo-mota/G1IndustrialSortingTeleop-psi0",
            base_config=DataConfig(prompt_from_task=True),
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader("gs://openpi-assets/checkpoints/pi05_droid/params"),
        num_train_steps=40_000,
        ...
        pytorch_weight_path=f"{os.environ['PSI_HOME']}/cache/checkpoints/openpi/pi05_droid",
        policy_metadata={"dataset": "G1IndustrialSortingTeleop-psi0"},
        checkpoint_base_dir=f".runs/openpi-05"
    ),
        TrainConfig(
        ...
        data=LeRobotHFMDataConfig(
            repo_id=f"{os.environ['PSI_HOME']}/data/lGabrielJJ/G1WholebodyLocomotionPickTotesShelfToTableTeleop",
            base_config=DataConfig(prompt_from_task=True),
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader("gs://openpi-assets/checkpoints/pi05_droid/params"),
        num_train_steps=40_000,
        ...
        pytorch_weight_path=f"{os.environ['PSI_HOME']}/cache/checkpoints/openpi/pi05_droid",
        policy_metadata={"dataset": "G1WholebodyLocomotionPickTotesShelfToTableTeleop"},
        checkpoint_base_dir=f".runs/openpi-05"
    ),
        TrainConfig(
        ...
        data=LeRobotHFMDataConfig(
            repo_id=f"{os.environ['PSI_HOME']}/data/AKCITWMOPOC/G1PickUpToteFromShelfToDeskPsi0",
            base_config=DataConfig(prompt_from_task=True),
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader("gs://openpi-assets/checkpoints/pi05_droid/params"),
        num_train_steps=40_000,
